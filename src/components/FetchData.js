...
const FetchData = ({cat}) => {
    ...
    const fetchData = async () => {
        await axios
            .get(
                cat ? `https://newsapi.org/v2/top-headlines?country=in&category=${cat}&apiKey=f3d6a0cba77e4e13a6b1d5c4ca44884d`:
                "https://newsapi.org/v2/top-headlines?country=in&apiKey=f3d6a0cba77e4e13a6b1d5c4ca44884d"
            )
